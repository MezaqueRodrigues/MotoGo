...
-- Copiando dados para a tabela db_motogo.empresa: ~3 rows (aproximadamente)
/*!40000 ALTER TABLE `empresa` DISABLE KEYS */;
INSERT INTO `empresa` (`idempresa`, `cnpj`, `rua`, `numero`, `bairro`, `estado`, `cidade`, `cep`, `telefone`, `usuario_idusuario`) VALUES
	(1, '12.456.456/0001-55', 'Rua teste', '12', 'centro', NULL, 'Ouro Fino', '37.878-889', '(25) 1232-4566', 3),
	(7, '12345678', 'Rua das flores', '123', 'centrão', NULL, 'Inconfidentes', '375760000', '35-9999-0000', 15),
	(10, '11111', 'Rua das Margaridas', '123', 'Centro', 'Minas Gerais', 'Inconfidentes', '3579-000', '(35) 1233-4568', 36);
...
CREATE TABLE IF NOT EXISTS `encomendas` (
  ...
  `retirada_rua` varchar(100) DEFAULT NULL,
  `retira_numero` varchar(45) DEFAULT NULL,
  `retirada_bairro` varchar(45) DEFAULT NULL,
  `retirada_estado` varchar(45) DEFAULT NULL,
  `retirada_cidade` varchar(45) DEFAULT NULL,
  `retirada_cep` varchar(45) DEFAULT NULL,
  `entrega_rua` varchar(45) DEFAULT NULL,
  `entrega_numero` varchar(45) DEFAULT NULL,
  `entrega_bairro` varchar(45) DEFAULT NULL,
  `entrega_estado` varchar(45) DEFAULT NULL,
  `entrega_cidade` varchar(45) DEFAULT NULL,
  `entrega_cep` varchar(45) DEFAULT NULL,
...
INSERT INTO `encomendas` (`idencomendas`, `descricao_produto`, `retirada_rua`, `retira_numero`, `retirada_bairro`, `retirada_estado`, `retirada_cidade`, `retirada_cep`, `entrega_rua`, `entrega_numero`, `entrega_bairro`, `entrega_estado`, `entrega_cidade`, `entrega_cep`, `peso`, `dimensoes_produto`, `valor_entrega`, `status`, `empresa_idempresa`) VALUES
	(9, 'Pedido nº 12345 - Pizza Brócolis', 'Inconfidentes', '1', 'centro', 'mg', 'incofidentes', '37576-000', 'rua das flores', '12', 'centro', 'mg', 'ouro fino', '37578-000', 1, '200*85*87', 6.00, 'ENTREGADOR A CAMINHO', 10),
	(10, 'Pedido nº 12345 - Pizza Brócolis', 'Inconfidentes', '1', 'santa luzia', 'mg', 'ouro fino', '31548-00', 'rua teste', '14', 'centro', 'mg', 'borda da mata', '35488-000', 1, NULL, 6.00, 'CRIADO', 10);
...
-- Copiando dados para a tabela db_motogo.motoboy: ~5 rows (aproximadamente)
/*!40000 ALTER TABLE `motoboy` DISABLE KEYS */;
INSERT INTO `motoboy` (`id`, `telefone`, `cpf`, `cnh`, `rua`, `numero`, `bairro`, `cidade`, `estado`, `cep`, `data_nascimento`, `placa_moto`, `sexo`, `usuario_idusuario`) VALUES
	(23, '(35) 7898-4565', '2', '132132', 'Rua Teste', '10', 'Centro', 'Inconfidentes', 'MG', '375760000', '2021-10-25', NULL, NULL, 16),
	(25, '(35) 3464-1200', '3', 'a', 'Rua Joaquim Pinheiro', '125', 'Centro', 'Ouro Fino', 'MG', '78020-50', '1986-04-26', NULL, NULL, 20),
	(38, '35 3464-1234', '123.456.789-78', '123.456.78', 'Rua Joaquim Pinheiro', '52', 'Centro', 'Inconfidentes', 'MG', '37576-000', '2021-11-30', NULL, NULL, 27),
	(50, '(35)1111-1111', '123.456.789-33', '123', 'Rua das Flores', '35', 'Centro', 'Inconfidentes', 'Minas Gerais', '37.576-000', '2020-02-05', 'ABC-1234', 'Masculino', 28),
	(51, '35 11111+11111', '11111111', '1111', 'Rua das flores', '75', 'Centro', 'Inconfidentes', 'Minas Gerais', '375768000', '2021-12-08', 'HGF-000', 'Masculino', 34);
...
-- Copiando dados para a tabela db_motogo.usuario: ~20 rows (aproximadamente)
...
INSERT INTO `usuario` (`idusuario`, `nome`, `email`, `senha`, `foto`, `tipo`) VALUES
	...
	(15, 'Loja do Paraguai', 'paraguai@gmail.com', '$2y$10$kuZJzhrc0Iq5lnw0NI6LwemaOylDTEfOLjy02OGIMyAgL1Oyg1X6y', 'photos/1633546347_17b1bb8d9eae7ee9b9cb.jpg', 'Empresa'),
	...
	(34, 'Luiz Claudio', 'claudio@gmail.com', '$2y$10$03wJ.4tuzDVDmNr8DrZov.LNkbebCxr90kCC1g8qGUfZnaUlmZOP6', NULL, 'Motoboy'),
	(36, 'Flaávia Aparecida', 'flaavia@gmail.com', '$2y$10$Bjm3Sqw6ZpMUZayS0NQ2ZuwjHzaCcKqG1Bx9WXGVtd0SMI7wsu7qS', NULL, 'Empresa');
